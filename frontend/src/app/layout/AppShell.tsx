...
export function AppShell() {
  ...
  return (
    <div className="min-h-screen bg-[#f9faf6] text-[#1a1c1a]">
      ...
      <nav
        className="fixed bottom-0 left-0 z-50 flex w-full items-center justify-around rounded-t-[3rem] bg-[#ffffffcc] px-4 pb-6 pt-3 shadow-[0_-8px_32px_rgba(15,82,56,0.06)] backdrop-blur-xl"
      >
