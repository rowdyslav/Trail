    ...
    <main className="relative">
          ...
          <div className="order-2 z-10 lg:order-1">
            ...
            <div className="grid max-w-xl gap-3 sm:grid-cols-3">
              <div className="rounded-[1.5rem] bg-white px-4 py-4 shadow-sm">
                <p
                  className="text-xs font-bold uppercase tracking-[0.1em] text-[#5a645d]"
                >Бесплатных маршрута
                </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        ...
        <div className="mb-4 grid grid-cols-1 gap-6 md:grid-cols-3">
          <div
            className="group relative flex flex-col justify-between overflow-hidden rounded-lg bg-[#edeeea] p-8 md:col-span-2"
          >
            <div className="z-10">
          ...
          {authToken ? (
            <div
              className="relative flex flex-col justify-between overflow-hidden rounded-lg bg-[#0f5238] p-8 text-white"
            >
              <div className="z-10">
                ...
                <Link
                  to="/redeem" className="inline-flex rounded-full bg-white px-4 py-3 text-sm font-bold text-[#0f5238]"
                >
                  Обменять очки
                </Link>
              </div>
            ...
            >
              <div className="z-10">
                ...
                <Link
                  to="/auth" className="inline-flex rounded-full bg-white px-4 py-3 text-sm font-bold text-[#0f5238]"
                >
          ...
          <div
            className="relative flex items-center justify-between overflow-hidden rounded-lg bg-[#cbebc8] p-8 md:col-span-2"
          >
